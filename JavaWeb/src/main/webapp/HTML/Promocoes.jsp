...
<body>
    ...
    <main>
        ...
        <div class="card" style="width: 18rem;">
            <img src="../imagens/Vaticano.jpg" class="card-img-top" alt="Vaticano" style="width: 286px; height: 320px;">
            <div class="card-body">
                <h5 class="card-title">Vaticano</h5>
                <p class="card-text">A Cidade do Vaticano, uma cidade-estado cercada por Roma, Itália, é a sede da
                    Igreja Católica Romana. Ela é a residência do Papa e está repleta de tesouros da arte e da
                    arquitetura.</p>
                <hr>
                <p> R$4.250,00</p>
        ...
        <div class="card" style="width: 18rem;">
            <img src="../imagens/Madrid.jpg" class="card-img-top" alt="Madrid - EUR ES"
                style="width: 286px; height: 320px;">
            <div class="card-body">
                <h5 class="card-title">Madrid </h5>
                <p class="card-text">Madri, a capital da Espanha, situada no centro do país, é uma cidade de avenidas
                    elegantes e parques grandes e bem cuidados, como o Buen Retiro.</p>
                <hr>
                <p> R$5.250,00</p>
                <a href="#" class="btn btn-outline-success">Comprar</a>
            </div>
        ...
        <div class="card" style="width: 18rem;">
            <img src="../imagens/Berlin.jpg" class="card-img-top" alt="Berlin - EUR DE"
                style="width: 286px; height: 320px;">
            <div class="card-body">
                <h5 class="card-title">Berlin</h5>
                <p class="card-text">Berlim, a capital da Alemanha, existe desde o século XIII. Algumas recordações da
                    história turbulenta da cidade no século XX são o Memorial do Holocausto e as ruínas do Muro de
                    Berlim, repletas de grafites.</p>
                <hr>
                <p> R$6.000,00</p>
                <a href="#" class="btn btn-outline-success">Comprar</a>
            </div>
