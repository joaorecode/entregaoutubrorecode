...
<body>
   <header>
    ...
    <main>
        <!--  Início da comunicação por redes sociais -->
        <div class="card" style="width: 18rem;">
            <img src="../imagens/Facebook.jpg" class="card-img-top" alt="Facebook" style="width: 286px; height: 320px;">
            <div class="card-body">
                <h5 class="card-title">Facebook</h5>
                <p class="card-text" style="color: purple; text-decoration: underline;"> FlyUs Suporte</p>
                <p style="color: purple; text-decoration: underline;"> FlyUs Comunity</p>
                <hr>
                <p> Mande uma mensagem direto</p>
                <a href="#" class="btn btn-outline-success">Messenger</a>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <img src="../imagens/Instagram.jpg" class="card-img-top" alt="Instagram" style="width: 286px; height: 320px;">
            <div class="card-body">
                <h5 class="card-title">Instagram </h5>
                <p class="card-text" style="color: purple; text-decoration: underline;">@FlyUs</p>
                <p style="color: purple; text-decoration: underline;">@SuporteFlyUs</p>
                <hr>
                <p>Mande uma mensagem direto</p>
                <a href="#" class="btn btn-outline-success">Direct</a>
            </div>
        </div>
