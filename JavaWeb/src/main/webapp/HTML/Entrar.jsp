...
<body>
    ...
    <main>
        <!--  Começo do conteúdo central -->
        <div id="left">
            <!--  Conteúdo da esquerda -->
            <h1>Entre para aproveitar!</h1>
            <img src="../imagens/entrar.svg" alt="" id="img-1">
        </div>
        ...
        <div id="right">
            ...
            <form id="entrar">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Senha Aqui">
                </div>
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                    <label class="form-check-label" for="exampleCheck1">Não sou um robô</label>
                </div>
                <p>Não possui uma conta? <a href="Cadastrar.jsp">Cadastre-se</a></p>
                <button type="submit" class="btn btn-primary">Enviar</button>
            </form>
        </div>
    </main> <!--  Fim do conteúdo central -->
